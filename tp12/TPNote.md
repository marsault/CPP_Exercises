...
Lors du TP Noté, vous trouverez dans `${HOME}/SUJET` deux fichiers:
...
- le fichier [`tp12.zip` ](https://github.com/marsault/CPP_Exercises/raw/refs/heads/master/large-files/tp12.zip?download=)
- le fichier [`prepare_station.py`](https://github.com/marsault/CPP_Exercises/raw/refs/heads/master/large-files/prepare_station.py?download=)
