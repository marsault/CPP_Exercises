...
// Est-ce que l'implémentation 1 est meilleure que l'implémentation 2?
#define ANSWER_2 \
  false // L'implémentation 1 stocke une référence à une variable locale, c'est n'importe quoi
...
#endif
// Est-ce que l'utilisation de la classe ci-dessus est susceptible de créer des problèmes de mémoire
// (fuite, double-déallocation, etc.) ?
...
// 2X. //
// ===================================================================================================
// Pour les questions 2X, on conside un programme avec deux classes, Fille et Mère, où Fille hérite
// de Mère. Les deux classes Fille et Mere possèdent une fonction-membre void fct().
#ifdef CODE_IGNORE_PAR_LE_COMPILATEUR
int main()
{
...
#endif
// 20. Si je veux redéfinir fct() dans Fille, je dois utiliser le mot-clef "virtual" dans la
// déclaration on de Mere::fct(), sans quoi Fille::fct() ne sera pas appelée à la ligne 2 ci-dessus.
#define ANSWER_20 true
// 21. Si je veux redéfinir fct() dans Fille, je dois utiliser le mot-clef "virtual" dans la
// déclaration de Fille::fct(), sans quoi Fille ::fct() ne sera pas appelée à la ligne 2 ci-dessus.
...
// 25. S'il est impossible d'instancier la classe Mere, le code à la ligne 1 ci-dessus ne compile
// pas.
#define ANSWER_25 false // le code compile bien !
