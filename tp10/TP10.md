...
4. Faites le nécessaire pour que l'on puisse additionner deux images de même taille. Le résultat produira une image dont chaque pixel est la somme des deux pixels situés à la même position dans les deux images d'origine.
...
6. Testez votre code avec les fichiers `gray.cpp` et `grayscale.cpp`.
